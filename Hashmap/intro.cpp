/**
 * @brief This code demonstrates the usage of hashmaps in C++.
 *
 * Hashmaps are a type of data structure that maps keys to values, where each key should be unique.
 * This code shows how to create a hashmap, insert elements into it, search for elements, erase elements,
 * check the size of the hashmap, and iterate over its elements.
 * The time complexity for insertion, deletion, and searching operations in a hashmap is O(1).
 */
